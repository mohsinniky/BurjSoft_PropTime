...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // First toast button
  document
    .getElementById("firstToastBtn")
    .addEventListener("click", function () {
      const toastElement = document.getElementById("firstToast");
      const toast = bootstrap.Toast.getOrCreateInstance(toastElement);
      toast.show();
    });
  ...
  // Second toast button
  document
    .getElementById("secondToastBtn")
    .addEventListener("click", function () {
      const toastElement = document.getElementById("secondToast");
      const toast = bootstrap.Toast.getOrCreateInstance(toastElement);
      toast.show();
    });
});
