...
namespace CoreMVCTutorial.Models
{
    ...
    public class Students
    {
        ...
        [Required(ErrorMessage = "Name is required")] // Ensures name is entered
        [StringLength(50, MinimumLength = 2, ErrorMessage = "Name must be between 2 and 50 characters")] // Limits name length
        public string FullName { get; set; }

        [Required(ErrorMessage = "Password is required")] // Ensures password is entered
        [DataType(DataType.Password)]
        [StringLength(100, MinimumLength = 8, ErrorMessage = "Password must be at least 8 characters")] // Password length restriction
        [RegularExpression(@"^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&]{8,}$", ErrorMessage = "Password must contain letters and numbers")] // Password complexity
        public string Password { get; set; }

        [Required(ErrorMessage = "Date of Birth is required")] // Ensures DOB is entered
        [DataType(DataType.Date)]
        [Range(typeof(DateTime), "1/1/1950", "12/31/2020", ErrorMessage = "Date of Birth must be between 1950 and 2020")] // Valid DOB range
