...
namespace Day9_onwards
{
    public class Basics
    {
        public void Show()
        {
            ...
            //Arrays 
            //Array Syntax: arrayDatatype[] VariableName = {value1, value2, ...., valueN};
            ...
            Console.WriteLine("Max Number in Array: " + numberArray.Max());  // returns the largest value
            Console.WriteLine("Min Number in Array: " + numberArray.Min());  // returns the smallest value
            Console.WriteLine("Sum Of Number in Array: " + numberArray.Sum());


            //Functions/Methods

            static int twoNumSum(int x, int y)
            {
                return x + y;
            }

            Console.WriteLine(twoNumSum(5, 10) + "< == Sum of two Numbers Using Method");
        }
    }
}
